...
<head>
    ...
    <style>
     form div[id$='_bol'] .jq-ry-rated-group svg 
        {
          fill:red;
        }
    </style>
            ...
            <div class="row">
                <ul id="myUL">
                    <li>
                        ...
                        <ul class="nested">
                            <li><span class="caret">You are given <span style="color:green;font-weight:bold">3 green stars</span> and <span style="color:red;font-weight:bold">3 red stars</span> to rate the following set of ideas:</span></li>
                            ...
                            <li><span class="caret">Place your <span style="color:red;font-weight:bold">red stars</span> on the ideas that you deem to be least useful, feasible and innovative.</span></li>
                            <li><span class="caret">You only have the right to use <span style="color:green;font-weight:bold">3 green stars</span> & <span style="color:red;font-weight:bold">3 red stars</span> in total. Make sure to use them wisely.</span></li>
                            <li><span class="caret">PS: Every submission that exceeds <span style="color:green;font-weight:bold">3 green stars</span> & <span style="color:red;font-weight:bold">3 red stars</span> will not be considered.</span></li>
                        </ul>
                    </li>
                </ul>
                <form action="hybrid.php" method="post">

                    <div>
                        <br><h3>Rate ideas using the Green and Red Stars.</h3>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="row mb-3">
                        ...
                        <ul id="myUL">
                            <li>
                                ...
                                <ul class="nested">
                                    ...
                                    <li><span class="caret">You are asked to rate them performing pairwise comparisons according to these three main criterias:</span></li>
                                    <li><span class="caret">(Remember to use the green stars with the best and the red stars with the worst)</span></li>
                                    ...
                                    <li><span class="caret"><span style="font-weight:bold">(0 green: bad, 1 green: good, 2 green: very good)</li>
                                    <li><span class="caret"><span style="font-weight:bold">(0 red: good, 1 green: bad, 2 green: very bad)</li>
                                </ul>
                            </li>
                        </ul>
                        </div>
                        ...
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating1_bos" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating1_bos">
                        </div>
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating1_bol" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating1_bol">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating2_bos" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating2_bos">
                        </div>
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating2_bol" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating2_bol">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating3_bos" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating3_bos">
                        </div>
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating3_bol" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating3_bol">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating4_bos" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating4_bos">
                        </div>
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating4_bol" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating4_bol">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="ratin5_bos" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating5_bos">
                        </div>
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating5_bol" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating5_bol">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating6_bos" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating6_bos">
                        </div>
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating6_bol" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating6_bol">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating7_bos" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating7_bos">
                        </div>
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating7_bol" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating7_bol">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating8_bos" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating8_bos">
                        </div>
                        <div class="col-md-2 themed-grid-col">
                            <div class="rateyo" id="rating8_bol" data-rateyo-rating="0" data-rateyo-num-stars="2" data-rateyo-score="3">
                            </div>
                            <span class='result'>0</span>
                            <input type="hidden" name="rating8_bol">
                        </div>
                    </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $rating1_bos = $_POST["rating1_bos"];
    $rating2_bos = $_POST["rating2_bos"];
    $rating3_bos = $_POST["rating3_bos"];
    $rating4_bos = $_POST["rating4_bos"];
    $rating5_bos = $_POST["rating5_bos"];
    $rating6_bos = $_POST["rating6_bos"];
    $rating7_bos = $_POST["rating7_bos"];
    $rating8_bos = $_POST["rating8_bos"];
    $rating1_bol = $_POST["rating1_bol"];
    $rating2_bol = $_POST["rating2_bol"];
    $rating3_bol = $_POST["rating3_bol"];
    $rating4_bol = $_POST["rating4_bol"];
    $rating5_bol = $_POST["rating5_bol"];
    $rating6_bol = $_POST["rating6_bol"];
    $rating7_bol = $_POST["rating7_bol"];
    $rating8_bol = $_POST["rating8_bol"];


    $sql = "INSERT INTO 
    hybrid (name,email,expertise,rate1_bos,rate2_bos,rate3_bos,rate4_bos,rate5_bos,rate6_bos,rate7_bos,rate8_bos,
    rate1_bol,rate2_bol,rate3_bol,rate4_bol,rate5_bol,rate6_bol,rate7_bol,rate8_bol) 
    VALUES (
        '$name','$email','$expertise','$rating1_bos','$rating2_bos','$rating3_bos', '$rating4_bos', '$rating5_bos', '$rating6_bos', '$rating7_bos', '$rating8_bos',
        '$rating1_bol','$rating2_bol','$rating3_bol','$rating4_bol','$rating5_bol','$rating6_bol','$rating7_bol','$rating8_bol'
        )";
